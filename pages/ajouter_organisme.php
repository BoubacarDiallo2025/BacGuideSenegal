...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO organisme_gouvernemental (nom, type, adresse, email, tel) VALUES (?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$nom, $type, $adresse, $email, $tel]);

    echo "Organisme gouvernemental ajouté avec succès !";
}
?>

<div class="container mt-5">
    <h2>Ajouter un organisme gouvernemental</h2>
    <form method="POST">
